              ...
              <Card>
                ...
                <div className="space-y-2 ml-4 mb-4 gap-2">
                  <p>
                    ...
                    {documentUrl.substring(documentUrl.lastIndexOf('-') + 1, documentUrl.lastIndexOf('.'))}
                  </p>
                  <p>
                    <strong>Fecha:</strong> {row?.date ? moment(row.date).format('DD/MM/YYYY') : 'N/A'}
                  </p>
                  <p>
                    <strong>Cliente:</strong> {decodedCustomerName}
                  </p>
                  <p>
                    <strong>Servicio:</strong> {decodedServiceName}
                  </p>
                  <p>
                    <strong>Item:</strong> {itemName}
                  </p>
                  <p>
                    <strong>Empleados Asignados:</strong> {employeeNames ? employeeNames.join(', ') : 'N/A'}
                  </p>
                  <p>
                    <strong>Equipos Asignados:</strong> {equipmentNames ? equipmentNames.join(', ') : 'N/A'}
                  </p>
                  <p>
                    <strong>Jornada:</strong> {row?.working_day || 'N/A'}
                  </p>
                  <p>
                    <strong>Estado:</strong> {row?.status || 'N/A'}
                  </p>
                </div>
              </Card>
            </TabsContent>
              ...
              <Card>
                <div className="p-3 text-center space-y-3">
                  <CardDescription>
                    <InfoComponent
                      size="md"
                      message={`Si el documento subido no es el correcto, puedes actualizarlo aquí.`}
                    />
                  </CardDescription>
                  <div className="w-full flex justify-evenly flex-wrap">
                    <UploadDocument
