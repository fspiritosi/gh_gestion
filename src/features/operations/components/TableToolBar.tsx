  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        {/* Filtro por cliente */}
        <Select onValueChange={(value) => filterByValue('customer', value)}>
        ...
        {/* Filtro por servicio */}
        <Select onValueChange={(value) => filterByValue('services', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Servicio</span>
          </SelectTrigger>
          <SelectContent>
        ...
        {/* Filtro por item */}
        <Select onValueChange={(value) => filterByValue('item', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Item</span>
          </SelectTrigger>
          <SelectContent>
        ...
        <Select onValueChange={(value) => filterByValue('employees', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Empleados</span>
          </SelectTrigger>
          <SelectContent>
        ...
        {/* Filtro por equipos */}
        <Select onValueChange={(value) => filterByValue('equipment', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Equipos</span>
          </SelectTrigger>
          <SelectContent>
        ...
        {/* Filtro por jornada */}
        <Select onValueChange={(value) => filterByValue('working_day', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Jornada</span>
          </SelectTrigger>
          <SelectContent>
        ...
        {/* Filtro por estado */}
        <Select onValueChange={(value) => filterByValue('status', value)}>
          <SelectTrigger className="h-6 w-24 border-spacing-1 ml-2">
            <span>Estado</span>
          </SelectTrigger>
          <SelectContent>
