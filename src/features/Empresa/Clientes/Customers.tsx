...
// export default async function Customers({tabValue, subtab}:{tabValue:string, subtab?:string}) {
...
//   return (
// <div className="">
// <ComercialTab tabValue={tabValue} subtab={subtab} columns={columns} data={contractorCompanies || []} localStorageName="customersColumns" />
