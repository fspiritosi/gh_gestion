...
import { Service, Item } from '@/features/company/modules/services/types/types';
...
export const itemOnUpdate = async (values: Service, editingService: Item, company_id: string, resetForm: () => void) => {
  const modified_company_id = company_id.replace(/"/g, '');
