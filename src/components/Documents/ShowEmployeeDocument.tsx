                          ...
                          <TableCell>
                            <CardDescription>
                              ...
                              {documents_employees?.[0]?.applies?.date_of_admission &&
                                moment(documents_employees?.[0]?.applies?.date_of_admission).format('DD/MM/YYYY')}
                            </CardDescription>
                          </TableCell>
                        </TableRow>
                                  ...
                                  <ul>
                                    <CardDescription>
                                      {documents_employees?.[0]?.applies?.contractor_employee?.map(
                                        (contractor: any) => {
                                          return (
                                            <li key={contractor?.contractors?.name}>{contractor?.contractors?.name}</li>
                                          );
                                        }
                                      )}
                                    </CardDescription>
