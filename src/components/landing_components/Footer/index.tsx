        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image src={Logo} alt="logo" width={140} height={30} className="w-full dark:hidden" />
                  <Image src={LogoBlanco} alt="logo" width={140} height={30} className="hidden w-full dark:block" />
                </Link>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Soluciones de softaware eficientes para tu empresa.{' '}
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://www.instagram.com/codecontrol_/"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  ...
                  <a
                    href="https://www.linkedin.com/company/codecontrol-argentina"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Nuestra APP</h2>
                <ul>
                  <li>
                    <Link
                      href="/login"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Terminos</h2>
                <ul>
                  <li>
                    <Link
                      href="/"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Soporte</h2>
                <ul>
                  <li>
                    <Link
                      href="/contact"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              @ 2024 Grupo Horizonte. All rights reserved.
            </p>
          </div>
        </div>
